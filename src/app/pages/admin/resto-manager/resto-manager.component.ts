...
@Component({
  selector: 'app-resto-manager',
  templateUrl: './resto-manager.component.html',
  styleUrls: ['./resto-manager.component.css']
})
export class RestoManagerComponent implements OnInit {
